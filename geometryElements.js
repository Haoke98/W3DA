    ...
    'cube':
        {
            ...
            createFunction: function () {
                var newMesh = new THREE.Mesh(new THREE.CubeGeometry(earthRadius * 2, earthRadius * 2, earthRadius * 2));
                newMesh.name = "Cube";
                return newMesh;
            }
        },
    ...
    'ball':
        {
            src: "./img/ball.png",
            createFunction: function () {
                var newMesh = new THREE.Mesh(new THREE.SphereGeometry(earthRadius, WIDTH_SEGMENTS, HEIGHT_SEGMENTS), new THREE.MeshBasicMaterial({color: getRendomColor()}));
                newMesh.name = "Ball";
                return newMesh;
            }
        }
